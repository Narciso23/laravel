...
@section('content')
 ...
 <!--==========================
    ...
    <!--============================
        BANNER PART 2 START
    ==============================-->
    @include('fontend.home.sections.barner-slider')
    <!--============================
        BANNER PART 2 END
    ==============================-->
    ...
    <!--============================
        SINGLE BANNER START
    ==============================-->
    @include('fontend.home.sections.single-barner')
    <!--============================
        SINGLE BANNER END  
    ==============================-->
    ...
    <!--============================
        LARGE BANNER  START  
    ==============================-->
    @include('fontend.home.sections.larg-barner')
    <!--============================
        LARGE BANNER  END  
    ==============================-->
    ...
    ==============================-->
    @include('fontend.home.sections.weekly-best-items')
    <!--============================
    ...
    <!--============================
      HOME SERVICES START
    ==============================-->
    @include('fontend.home.sections.service')
