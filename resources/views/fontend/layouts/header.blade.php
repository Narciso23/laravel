<header>
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                    <div class="wsus_logo_area">
                        <a class="wsus__header_logo" href="index.html">
                           <h1>Flexi<span class="w-100 text-white">cabos</h1></span>
                        </a>
                    </div>
                </div>
                <div class="col-xl-5 col-md-6 col-lg-4 d-none d-lg-block">
                    <div class="wsus__search">
                        <form>
                            ...
                            <button class="bg-yellow" type="submit"><i class="far fa-search"></i></button>
                        </form>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="btn-group">
                        <button type="button" class="btn btn-outline-secondary language-btn" onclick="changeLanguage('en')">
                        <img src="fontend/images/En.png" alt="English" class="mr-2 small-image" width="50px">EN
                        </button>
                        <button type="button" class="btn btn-outline-secondary language-btn w-100" onclick="changeLanguage('pt')">
                        <img src="fontend/images/PT.jpg" alt="English" class="mr-2 small-image" width="50px">PT
                        </button>
                        <button type="button" class="btn btn-outline-secondary   language-btn" onclick="changeLanguage('fr')">
                        <img src="fontend/images/FR.png" alt="English" class="mr-2 small-image" width="50px">FR
                        </button>
                    </div>
                </div>
