            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="relative_contect d-flex">
                        ...
                        <li class="wsus__relative_li"><a href="#">Product <i class="fas fa-caret-down"></i></a>
                            ...
                            <li><a class="active" href="index.html">Service</a></li>
                            <li><a href="product_grid_view.html">Solutions <i class="fas fa-caret-down"></i></a>
                            ...
                            <li><a href="vendor.html">Resource</a></li>
                            <li><a href="{{ route('training.page') }}">Training</a></li>
